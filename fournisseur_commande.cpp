...
#include "ui_fournisseur_commande.h"
#include "comd.h"
#include<QPrinter>
...
#include <QMessageBox>
#include "fourn.h"
Fournisseur_commande::Fournisseur_commande(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::Fournisseur_commande)
{
    ui->setupUi(this);
...
void Fournisseur_commande::on_pb_ajouter_clicked()//button ajouter
{
...
void Fournisseur_commande::on_comboBox_2_currentIndexChanged(int index)
{
    int a;
        a=index;
        index=a;
...
void Fournisseur_commande::on_pb_modifier_2_clicked()
{
...
void Fournisseur_commande::on_comboBox_4_currentIndexChanged(int index)
{
    int a;
        a=index;
...
void Fournisseur_commande::on_pb_supprimer_clicked()
{
...
void Fournisseur_commande::on_pb_ajoutercommande_clicked()
{
    comd c(ui->le_numcommande->text().toInt(),ui->le_quantite->text().toInt(),ui->le_prix->text().toInt(),ui->le_description->text(),ui->cb_matF->currentText().toInt(),ui->le_dateachat->text(),ui->cb_produitcommande->currentText());
...
void Fournisseur_commande::on_cb_matF_currentIndexChanged(int index)
{
     ui->cb_matF->currentText();
}

void Fournisseur_commande::on_numcmd_combo_currentIndexChanged(int index)
{
    ui->numcmd_combo->currentText();

}

void Fournisseur_commande::on_numcmd_combo_2_currentIndexChanged(int index)
{
       ui->numcmd_combo_2->currentText();
}

void Fournisseur_commande::on_pb_modifier_5_clicked()
{
...
void Fournisseur_commande::on_pb_supprimer_2_clicked()
{
...
void Fournisseur_commande::on_pushButton_2_clicked()
{
    co.genererPDFcmd();
}


void Fournisseur_commande::on_le_recherche_2_textChanged(const QString &arg1)
{
...
void Fournisseur_commande::on_tri_fournisseur_clicked()
{
...
void Fournisseur_commande::on_pushButton_clicked()
{
    QPrinter  printer;
...
void Fournisseur_commande::on_pushButton_3_clicked()
{
    QTableView *table;
