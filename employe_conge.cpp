...
Employe_conge::Employe_conge(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::Employe_conge)
{
...
void Employe_conge::on_Ajouter_clicked()
{
...
void Employe_conge::on_comboBox_currentIndexChanged(int index)
{
    int a;
        a=index;
...
void Employe_conge::on_Supprimer_clicked()
{
...
void Employe_conge::on_comboBox_2_currentIndexChanged(int index)
{
    int a;
        a=index;
        index=a;
...
void Employe_conge::on_Modifier_clicked()
{
...
void Employe_conge::on_le_rech_textChanged(const QString &arg1)
{
...
void Employe_conge::on_comboBox_emplo_currentIndexChanged(int index)
{
    int a;
        a=index;
...
/*///////////////////////////////////////////////////////////////////////////////////////////////////////*/
void Employe_conge::on_Ajouter_conge_clicked()
{
...
void Employe_conge::on_comboBox_3_currentIndexChanged(int index)
{
    int a;
        a=index;
...
void Employe_conge::on_Supprimer_conge_clicked()
{
...
void Employe_conge::on_Modifier_conge_clicked()
{
...
void Employe_conge::on_Imprimer_clicked()//excel
{ QTableView *table;
    table = ui->tableView;
...
void Employe_conge::on_Pdf_conge_clicked()
{
 co.genererPDF();
}
...
void Employe_conge::on_pushButton_clicked()
{
    stat_liv=new statelivrec(this);
    stat_liv->show();
}

void Employe_conge::on_button_tri_clicked()
{
...
void Employe_conge::on_pushButton_2_clicked()
{
    QPrinter  printer;
